...
HT_tuning_semillerio <- function( pinputexps, semillerio, bo_iteraciones, bypass=FALSE)
{
  ...
  param_local$lgb_param <- list(
    ...
    bagging_fraction = 0.856371, # 0.0 < bagging_fraction <= 1.0
    ...
    extra_trees = FALSE,
    # Parte variable
    learning_rate = 0.010187,
    feature_fraction = 0.899919,
...
semillerio_combine_1 <- function( pnombrewf )
{
